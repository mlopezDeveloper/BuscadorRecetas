function iniciarApp(){
    ...
    function mostrarRecetas(recetas = []) {
        ...
        recetas.forEach( receta => {
            ...
            recetaImagen.src = strMealThumb ?? receta.img;//Si no existe busco en el localStorage (receta.img)
    ...
    function agregarFavorito(receta){
        const favoritos = JSON.parse(localStorage.getItem('favoritos')) ?? []; //si es null ?? -> aplica el []
